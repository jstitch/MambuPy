...
from ..mambuutil import getsavingstransactionsurl, getsavingstransactionssearchurl, MambuError, strip_tags
...
class MambuSavingTransactions(MambuStruct):
    ...
    """
    def __init__(self, urlfunc=mod_urlfunc, entid='', itemclass=MambuSavingTransaction, *args, **kwargs):
...
class MambuSavingsTransactionSearch(MambuStruct):
    ...
    """
    def __init__(self, urlfunc=mod_urlfunc_search, entid='', itemclass=MambuSavingTransaction, *args, **kwargs):
        """By default, entid argument is empty. That makes perfect
        sense: you want several groups, not just one.
        """
        self.itemclass = itemclass
